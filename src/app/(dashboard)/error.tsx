    ...
    <div className="flex-1 flex flex-col items-center justify-center p-8 text-center min-h-[60vh]">
      <div className="glass-card p-8 rounded-3xl border border-rose-500/30 max-w-md w-full space-y-5">
        ...
        <div className="space-y-1">
          <h2 className="text-xl font-bold text-white">Unable to load this dashboard page</h2>
          <p className="text-xs text-slate-400">A component error occurred. You can retry or return to login.</p>
        </div>
